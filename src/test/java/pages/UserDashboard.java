...
public class UserDashboard {
 ...
 //   @FindBy(xpath = "//*[text()='Logout']")
   // public WebElement userDashboardLogOut;
    ...
    public WebElement reatedAtSelect;
    ...
    //Blog Category delete confirmation Successfully message -- Firdevs
    ...
    public WebElement iFrameMapContact;

    @FindBy(xpath = "//div[@class='contact-form-group']")
    public WebElement contactSendMessageVisible;

    @FindBy(xpath = "//button[@class='btn btn-primary fw6']")
    public WebElement ContactSendMessageButton;

    @FindBy(xpath = "//span[@class='invalid-feedback d-block']")
    ...
    //=================== Sevda's locators start

    @FindBy(xpath = "//*[@id='type_id']")
    public WebElement propertiesTypeSelect;

    @FindBy(xpath = "//*[@id='type_id']")
    public WebElement typexSelect;

    @FindBy(xpath = "(//*[@role='row'])[2]")
    public WebElement firstRowOfAddOnAccountPage;

    @FindBy(xpath = "//div[@class='single-widgets widget_category']")
    public WebElement blogCategoriesList;
    @FindBy(xpath = "//div[@class='sidebar_featured_property']")
    public WebElement featuredPropertiesList;
    @FindBy(xpath = "//div[@class='post-details']")
...
//------------------------Suleyman start-------------------
    ...
    @FindBy(xpath = "(//a[@class='br-selected br-current'])[3]")
    public WebElement starPoint1;

    @FindBy(xpath = "//a[@title='Houses for sale']")
    public WebElement houseForSaleText;
