...
public abstract class TestBaseReport {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Automation Engineers", "M.Metin , Sevda , Adem , Firdevs , Elif , Yusuf , Veysel , Enver , Suleyman ");
        extentHtmlReporter.config().setDocumentTitle("TestNG HauseHeaven TESTNG");
